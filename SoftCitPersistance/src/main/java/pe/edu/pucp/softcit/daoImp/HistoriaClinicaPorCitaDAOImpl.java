...
public class HistoriaClinicaPorCitaDAOImpl extends DAOImplBase implements HistoriaClinicaPorCitaDAO{
    ...
    protected void incluirValorDeParametrosParaModificacion() throws SQLException {
        this.statement.setInt(1,this.historiaPorCita.getCita().getIdCita());
        this.statement.setDouble(2,this.historiaPorCita.getPeso());
        this.statement.setDouble(3,this.historiaPorCita.getTalla());
        this.statement.setString(4,this.historiaPorCita.getPresionArterial());
        this.statement.setDouble(5,this.historiaPorCita.getTemperatura());
        this.statement.setInt(6,this.historiaPorCita.getFrecuenciaCardiaca());
        this.statement.setString(7,this.historiaPorCita.getMotivoConsulta());
        this.statement.setString(8,this.historiaPorCita.getTratamiento());
        this.statement.setString(9,this.historiaPorCita.getEvolucion());
        this.statement.setString(10,this.historiaPorCita.getRecomendacion());
        this.statement.setString(11,this.historiaPorCita.getReceta());
